...
const Navigation = () => {
  ...
  return (
    <div className="fixed w-screen py-4 flex flex-row-reverse gap-4 justify-start items-start px-2 md:px-6 z-50">
...
const MiniMenu: React.FC<MiniMenuProps> = ({ setOpen }) => {
  ...
  return (
    <div className="h-[480px] md:w-[25vw] w-[80vw] bg-gray-50 border border-black flex flex-col gap-4 uppercase font-medium font-[family-name:var(--font-geist-mono)] py-8 px-4 text-2xl absolute top-16 right-0 md:relative md:top-auto md:right-auto md:h-auto  mr-8 md:mr-0">
